<?php /* Smarty version 2.6.31, created on 2020-05-27 16:31:58
         compiled from default/views/month/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/month/ajax_template.html', 11, false),array('function', 'xla', 'default/views/month/ajax_template.html', 163, false),array('function', 'xlt', 'default/views/month/ajax_template.html', 163, false),array('modifier', 'date_format', 'default/views/month/ajax_template.html', 347, false),array('modifier', 'string_format', 'default/views/month/ajax_template.html', 348, false),)), $this); ?>
...
//=======================================================================================
        foreach ($events as $event) {
            ...
            elseif($_SESSION['pc_facility'] == $row['id']){
                    ...
                    echo "<div class='" . attr($evtClass) . " month_event' style='background-color:#DDDDDD' title='" . attr($divTitle) . "'".
                        " id='" . attr($eventdate) . "-" . attr($eventid) . "-" . attr($pccattype) . "'>";
