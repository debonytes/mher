<?php /* Smarty version 2.6.31, created on 2020-09-04 16:00:02
...
<div id="dateNAV">
<?php 
echo "   <a id='prevweek' href='$PREV_WEEK_URL' onclick='top.restoreSession()' title='" . xla("Previous Week") . "'>
...
echo "   <a id='nextweek' href='$NEXT_WEEK_URL' onclick='top.restoreSession()' title='" . xla("Next Week") . "'>
	      ...
	      $divTitle .= "\n" . $row['name'];
            ...
            // output the content
				...
				echo "<div class='" . attr($evtClass) . " event' style='top:".$evtTop."; height:".$evtHeight.
						...
						" id='" . attr($eventdate) . "-" . attr($eventid) . "-" . attr($pccattype) . "'".
						">";
				echo "<span style='color:red;text-align:center;font-weight:bold'>" . text($row['name']) . "</span>";
				echo "</div>\n";
			}
     } // end EVENT loop
